    ...
    return (
        <Wrapper>
            <svg className="whole" width={100} height={100} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="loader">
                    <animateTransform xlinkHref="#loader" attributeName="transform" attributeType="XML" type="rotate" from="0 50 50" to="360 50 50" dur="1s" begin="0s" repeatCount="indefinite" restart="always" />
...
const Wrapper = styled.div`
    ...
    text-align: center;
    .whole {
      animation: 1.5s linear infinite rotation_animation;
      height: 50px;
      width: 50px;
    }
